      ...
      fetch(`http://localhost:6001/carts/${item._id}`, {
        ...
        .then(data => {
          const updatedCart = cartItems.map(cartItem => {
            if (cartItem._id === item._id) { // Ensure you're comparing the correct IDs
              return {
                ...cartItem,
  ...
  return (
    <div className="section-container mt-40">
      <div className="bg-gradient-to-r from-0% from-[#FAFAFA] to-[#FCFCFC] to-100%">
        <div className="py-3 flex flex-col items-center justify-center gap-8">
          {/* texts */}
          <div className="px-24 space-y-7 text-center">
            <h2 className="md:text-5xl text-4xl font-bold md:leading-snug leading-snug">
              Items Added To Your <span className="text-green">Cart</span>
            </h2>
          </div>
        </div>
      </div>
