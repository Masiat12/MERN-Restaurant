      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        <div className="md:w-1/2">
          <div className="text-left md:w-4/5">
            ...
            <h2 className="title">Our Culinery Journey And Services</h2>
            <p className="my-5 text-secondary leading-[30px]">
            Rooted in passion, 
            we curate unforgettable dining experiences and offer exceptional services, 
            blending culinary artistry with warm hospitality.
            </p>

            <button className="btn font-semibold bg-green text-white px-8 py-3 rounded-full">Explore</button>
          </div>
        </div>
          ...
          <div className="grid sm-grid-cols-2 grid-cols-2 gap-8 items-center">
            {
                serviceLists.map((service) => (
                    ...
                    text-green cursor-pointer hover:border-indigo-600 transition-all duration-200 hover:border ">
                        ...
                        <p className="text-black text-sm">{service.des}</p>
